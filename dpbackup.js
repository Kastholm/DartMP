...
/* ---------------------------- Jesper & Jacob svagest --------------------------- */
  if (lack === jjPoints && lead === mtPoints) {
    teamOne = new Team("Jesper", "Jacob", 0, 17, "Jesper & Jacob");
    teamTwo = new Team("Lars", "Razzer", 0, 15, "Lars & Razzer");
    teamThree = new Team("Morten", "Torben", 0, 16, "Morten & Torben");
  } else if (lack === jjPoints && lead === lrPoints) {
    teamOne = new Team("Jesper", "Jacob", 0, 17, "Jesper & Jacob");
    teamTwo = new Team("Morten", "Torben", 0, 16, "Morten & Torben");
    teamThree = new Team("Lars", "Razzer", 0, 15, "Lars & Razzer");
  } else if (lack === mtPoints && lead === jjPoints) {
/* ---------------------------- Morten & Torben svagest --------------------------- */
    teamOne = new Team("Morten", "Torben", 0, 16, "Morten & Torben");
    teamTwo = new Team("Lars", "Razzer", 0, 15, "Lars & Razzer");
    teamThree = new Team("Jesper", "Jacob", 0, 17, "Jesper & Jacob");
  } else if (lack === mtPoints && lead === lrPoints) {
    teamOne = new Team("Morten", "Torben", 0, 16, "Morten & Torben");
    teamTwo = new Team("Jesper", "Jacob", 0, 17, "Jesper & Jacob");
    teamThree = new Team("Lars", "Razzer", 0, 15, "Lars & Razzer");
  } else if (lack === lrPoints && lead === jjPoints) {
/* ---------------------------- Lars & Razzer svagest --------------------------- */
    teamOne = new Team("Lars", "Razzer", 0, 15, "Lars & Razzer");
    teamTwo = new Team("Morten", "Torben", 0, 16, "Morten & Torben");
    teamThree = new Team("Jesper", "Jacob", 0, 17, "Jesper & Jacob");
...
function localS() {
  ...
  if (historyJSON) {
    ...
    let historikSpillerOne = historyArray.find(
      (x) => x["teamname"] == this.teamOne.teamName
    );
    let historikSpillerTwo = historyArray.find(
      (x) => x["teamname"] == this.teamTwo.teamName
    );
    let historikSpillerThree = historyArray.find(
      (x) => x["teamname"] == this.teamThree.teamName
    );
    if (historikSpillerOne || historikSpillerTwo || historikSpillerThree) {
     
      /* historikSpillerOne.place++; */
    } else {
      historyArray.push({
        teamname: this.teamOne.teamName,
        teamname: this.teamTwo.teamName,
        teamname: this.teamThree.teamName,
        /* place: place, */
      });
    }
  } else {
    historyArray = [
      { teamname: this.teamOne.teamName/* , place: place */ },{ teamname: this.teamTwo.teamName/* , place: place */ }, { teamname: this.teamThree.teamName/* , place: place */ },
    ];
  }
  // always saves here
